...
const LearningHub: React.FC<LearningHubProps> = ({ onBack, onLaunchTool }) => {
    
    const tools: Feature[] = [
        {
            id: 'hadith-reader',
            title: 'Hadith Collections',
            description: 'Explore authentic Hadith collections chapter by chapter.',
            icon: <Icons.Scroll />,
        },
        {
            id: 'history-bot',
            title: 'Islamic History Explorer',
            description: 'Interactive timeline and narratives from the Seerah and Caliphates.',
            icon: <Icons.History />,
        },
        {
            id: 'hadith-library-chat',
            title: 'Hadith AI Search',
            description: 'Ask AI to find specific Hadiths by topic or keyword.',
            icon: <Icons.Library />,
        },
        {
            id: 'linguistic-explorer',
            title: 'Linguistic Explorer',
            description: 'Deep dive into Arabic root words and Quranic etymology.',
            icon: <Icons.Learning />,
        },
        {
            id: 'lecture-summarizer',
            title: 'Khutbah AI Summarizer',
            description: 'Paste lectures or transcripts to extract themes and verses.',
            icon: <Icons.FileText />,
        }
    ];
        ...
        <div className="flex flex-col h-[85vh] w-full max-w-4xl mx-auto glass-card rounded-3xl overflow-hidden relative shadow-2xl animate-fade-in-up">
            ...
            <div className="flex items-center justify-between p-6 border-b border-secondary-light/50 bg-white/40 backdrop-blur-md">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="font-display font-bold text-xl text-primary-dark">Learning Center</h3>
                        <p className="text-xs text-secondary-dark">Expand your knowledge of the Deen</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                 ...
                 <div className="mt-8 p-6 bg-primary-dark/5 rounded-2xl border border-primary-dark/10">
                    <div className="flex items-center gap-3 mb-2">
                        <Icons.Bot />
                        <h4 className="font-bold text-primary-dark">Knowledge is Light</h4>
                    </div>
                    <p className="text-sm text-secondary-dark italic">
                        "Seek knowledge from the cradle to the grave."
                        <br/>
                        <span className="text-xs opacity-70 not-italic mt-1 block"></span>
                    </p>
                </div>
            </div>
        </div>
